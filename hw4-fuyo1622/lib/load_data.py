...
def load_data(json_path,args):
    ...
    if args.dataset_type == 'llff':
        ...
        images, poses, render_poses, hwf, i_split, save_paths = load_blender_data(json_path,args.datadir, args.half_res, args.testskip)
    ...
    data_dict = dict(
        ...
        irregular_shape=irregular_shape,save_paths=save_paths
    )
    return data_dict
